  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6"
       onClick={() => navigate('/dashboard/lok-sabha')}
          onKeyDown={(e) => {
      ...
      >
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Lok Sabha Session</h3>
          </div>
          <div className="text-gray-600 text-sm">
            <p>Session updates and proceedings</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Received Letters</h3>
          </div>
          <div className="text-gray-600 text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Sent Letters Public Interest</h3>
          </div>
          <div className="text-gray-600 text-sm">
            <p>Outgoing public interest letters</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Sent Letters Public Grievance</h3>
          </div>
          <div className="text-gray-600 text-sm">
            <p>Grievance response letters</p>
          </div>
        </div>
      </div>
    </>
