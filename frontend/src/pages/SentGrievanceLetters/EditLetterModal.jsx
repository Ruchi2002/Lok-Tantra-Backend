...
import { useUpdateSentGrievanceLetterMutation } from '../../store/api/appApi';

const EditLetterModal = ({ letter, onClose, categories, priorities, statuses }) => {
  const [updateLetter, { isLoading: updateLoading }] = useUpdateSentGrievanceLetterMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.data?.detail || 'Failed to update letter');
    }
  };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-6">
            ...
            <input
              type="text"
              value={letter.grievance_id}
              disabled
              className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600"
            />
            <p className="text-sm text-gray-500 mt-1">Grievance ID cannot be changed</p>
          </div>
          ...
          <div className="flex justify-end space-x-3 mt-6 pt-6 border-t">
            ...
            >
              {updateLoading && <FaSpinner className="animate-spin" />}
